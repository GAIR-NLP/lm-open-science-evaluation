...
def extract_math_answer(question, reasoning, task, options=None):
    answer = []
...
def extract_math_few_shot_cot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
    return extract_math_answer(question, reasoning, task, options)

def extract_olympiad_math_answer(question, reasoning, task, options=None):
...
def extract_last_single_answer(question, reasoning, task, options=None):
    return extract_answer(reasoning, exhaust=False)

def extract_gsm_few_shot_cot_answer(question, reasoning, task, options=None):
    if 'Q: ' in reasoning:
...
def extract_agieval_gaokao_mathcloze_few_shot_cot_test(question, reasoning, task, options=None):
    if '问题 ' in reasoning:
...
def extract_agieval_gaokao_mathqa_few_shot_cot_test(question, reasoning, task, options=None):
    if '问题 ' in reasoning:
        reasoning = reasoning.split("问题 ", 1)[0]
    if '答案是' in reasoning:
        ans = reasoning.split('答案是', 1)[1].strip()
...
def extract_sat_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_ocwcourses_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_last_choice_mmlu_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_mmlu_stem(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
    return extract_last_choice_mmlu_few_shot_answer(question, reasoning, task, options)

def extract_super_gpqa_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_last_choice_super_gpqa_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_super_gpqa(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
    return extract_last_choice_super_gpqa_few_shot_answer(question, reasoning, task, options)

def extract_mmmlu_zh_math(question, reasoning, task, options=None):
    if '问题：' in reasoning:
        reasoning = reasoning.split("问题：", 1)[0]
    patt = regex.search(r"所以答案是： \((?P<ans>[ABCD])\)", reasoning)

def extract_medqa(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
...
def extract_pubmedqa(question, reasoning, task, options=None):
...
def extract_minif2f_isabelle(question, reasoning, task, options=None):
    if 'Informal:' in reasoning:
        reasoning = reasoning.split("Informal:", 1)[0]
    return reasoning.strip()

def extract_cmath_few_shot_test(question, reasoning, task, options=None):
    if '问题：' in reasoning:
        reasoning = reasoning.split("问题：", 1)[0]
    if '答案是' in reasoning:
        ans = reasoning.split('答案是', 1)[1].strip()
        ...
        ans = extract_last_single_answer(question, reasoning, task, options)
    return ans

def extract_mathqa_few_shot_answer(question, reasoning, task, options=None):
    if 'Problem:' in reasoning:
        reasoning = reasoning.split("Problem:", 1)[0]
    return extract_sat_few_shot_answer(question, reasoning, task, options)

def extract_tabmwp_few_shot_answer(question, reasoning, task, options=None):
    ...
    if 'Please select from the following options:' in question:
        ...
        return extract_last_single_answer(question, reasoning, task, options=None)
...
def extract_super_gpqa_sft_answer(question, reasoning, task, options=None):
...
def extract_mmlu_pro_sft_answer(question, reasoning, task, options=None):
    return extract_super_gpqa_sft_answer(question, reasoning, task, options)

def extract_mmlu_sft_answer(question, reasoning, task, options=None):
...
def extract_gpqa_sft_answer(question, reasoning, task, options=None):
    return extract_mmlu_sft_answer(question, reasoning, task, options)

def extract_two_choice_sft_answer(question, reasoning, task, options=None):
...
def extract_five_choice_sft_answer(question, reasoning, task, options=None):
...
def extract_three_choice_sft_answer(question, reasoning, task, options=None):
...
def extract_adaptive_mc_sft_answer(question, reasoning, task, options=None):
    if not options:
